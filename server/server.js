...
Meteor.publish('users', function(key, username) {
...
Meteor.methods({
    ...
    authenticate: function(username, password) {
        var result = HTTP.post("https://www.bowdoin.edu/apps/mobile/login.php", {
            params: {
                username: username,
                password: password
            }
